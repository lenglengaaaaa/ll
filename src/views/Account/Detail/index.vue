    ...
    export default {
        ...
        methods: {
            ...
            getAccount(data){
                ...
                const { imagePath } = userDetail;

                this.imageUrl = imagePath ? `https://www.eplusview.com:8082/image/user/pic/${imagePath}` : avatar;
			...
			cropUploadSuccess(jsonData, field){
                ...
                this.updateAccount({
                    ...
                    if(!res)return;
                    this.imageUrl = `https://www.eplusview.com:8082/image/user/pic/${data}`; 
